...
import 'package:customer_app/features/uber_map_feature/data/models/generate_trip_model.dart';
import 'package:customer_app/features/uber_map_feature/domain/entities/uber_map_direction_entity.dart';
import 'package:customer_app/features/uber_map_feature/domain/entities/uber_map_get_drivers_entity.dart';
import 'package:customer_app/features/uber_map_feature/domain/entities/uber_map_prediction_entity.dart';
import 'package:customer_app/features/uber_map_feature/domain/use_cases/cancel_trip_usecase.dart';
import 'package:customer_app/features/uber_map_feature/domain/use_cases/generate_trip_usecase.dart';
import 'package:customer_app/features/uber_map_feature/domain/use_cases/get_rental_charges_usecase.dart';
...
import 'package:customer_app/features/uber_trips_history_feature/presentation/pages/uber_trips_history_page.dart';
...
class UberMapController extends GetxController {
  ...
  setPlaceAndGetLocationDeatailsAndDirection(
    ...
    if (sourcePlace == "") {
      ...
      print(
          "disLat ${destinationLatitude.value} disLng ${destinationLongitude.value}");
      addMarkers(
  ...
  addMarkers(double latitude, double longitude, String markerId, icon,
      String type, String infoWindow, Function()? onTap) async {
  ...
  generateTrip(UberDriverEntity driverData, int index) async {
    scheduleNotification("Message",
        "The driver reach Your pickup, and the trip is about starting :)");
